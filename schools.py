...
class StudentSubjectsScoreAPIView(APIView):
    ...
    def post(request, *args, **kwargs):
        ...
        if isinstance(student_first_name, str) and isinstance(student_last_name, str) and \
            isinstance(subjects_title, str) and isinstance(score, int):
...
class PersonnelDetailsAPIView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        your_result = [s for s in data_pattern if school_title in s]
